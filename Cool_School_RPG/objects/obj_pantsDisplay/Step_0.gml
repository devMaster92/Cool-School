...
if obj_character.pants >= 0
 {
  visible = true; //show this object
  spriteName = asset_get_index("spr_pants_" + string(obj_character.charType) + "_" + string(obj_character.pants)); //get the sprite_index name of an string
