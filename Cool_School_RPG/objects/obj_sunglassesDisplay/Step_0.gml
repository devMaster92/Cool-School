...
if obj_character.sunglasses >= 0
 {
  visible = true; //show this object
  spriteName = asset_get_index("spr_sunglasses_" + string(obj_character.charType) + "_" + string(obj_character.sunglasses)); //get the sprite_index name of an string
