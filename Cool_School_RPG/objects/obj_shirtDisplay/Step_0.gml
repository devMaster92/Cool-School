...
if obj_character.shirt >= 0
 {
  visible = true; //show this object
  spriteName = asset_get_index("spr_shirt_" + string(obj_character.charType) + "_" + string(obj_character.shirt)); //get the sprite_index name of an string
